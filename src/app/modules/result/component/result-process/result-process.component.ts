...
import { ResultProcess } from '../../models/result-process';
@Component({
  selector: 'app-result-process',
  templateUrl: './result-process.component.html',
  styleUrl: './result-process.component.scss'
})
...
if(this.commonForm.valid){
  this.resultProcess.USER_CODE = this.userCode;
  this.resultProcess.ORG_CODE = this.organizationCode;
  this.resultProcess.CAMPUS_CODE = this.campusCode;
  this.resultProcess.CLASS_CODE =  this.commonForm.controls["CLASS_NAME"].value;
  this.resultProcess.GROUP_CODE =  this.commonForm.controls["GROUP_NAME"].value;
  this.resultProcess.VERSION_CODE =  this.commonForm.controls["VERSION_NAME"].value;
  this.resultProcess.SESSION_CODE =  this.commonForm.controls["SESSION_NAME"].value;
  this.resultProcess.YEAR_CODE =  this.commonForm.controls["YEAR_NAME"].value;
  this.resultProcess.SEMESTER_CODE =  this.commonForm.controls["SEMESTER_NAME"].value;
  this.resultProcess.SECTION_CODE =  this.commonForm.controls["SECTION_NAME"].value;
  this.resultProcess.SHIFT_CODE =  this.commonForm.controls["SHIFT_CODE"].value;
  this.resultProcess.TERM_ID =  this.commonForm.controls["TERM_NAME"].value;
...
createResultProcess() {
  ...
  this.resultService
    .SaveExamResultPro(this.resultProcess)
    .pipe(takeUntil(this.destroy$))
    .subscribe((response:any) => {
